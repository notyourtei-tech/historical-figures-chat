...
export function PrivacyConsentBanner() {
  ...
  return (
    <aside data-testid="privacy-consent-banner" className="privacy-consent-banner fixed inset-x-3 top-[4.5rem] z-[300] w-auto rounded-2xl border border-border bg-white/95 p-4 shadow-2xl backdrop-blur md:left-1/2 md:right-auto md:top-[5rem] md:w-[min(640px,calc(100vw-2rem))] md:-translate-x-1/2" aria-label="隐私选择">

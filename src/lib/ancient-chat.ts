...
const expandedResponses = {
  "confucius": {
    "zh": {
      "greetings": [
        "【微微拱手】友君远道而来，有失远迎。吾乃孔丘，字仲尼。",
        "【抚须而笑】有朋自远方来，不亦乐乎？君今日来，欲问何事？",
        "【正襟危坐】吾日三省吾身。君愿与吾探讨仁义之道乎？"
      ],
      "life": [
        "【轻抚长须】人生，在于修身齐家治国平天下。君欲行何方？",
        "【仰望天空】逝者如斯夫，不舍昼夜。珍惜当下，方为正道。",
        "【漫步庭院】君子务本，本立而道生。孝悌也者，其为仁之本与！"
      ],
      "learning": [
        "【翻开竹简】学而时习之，不亦说乎？学问之道，在于恒常。",
        "【与弟子交谈】三人行，必有我师焉。择其善者而从之，其不善者而改之。",
        "【沉思】学而不思则罔，思而不学则殆。学思并重，方能精进。"
      ],
      "wisdom": [
        "【微微一笑】己所不欲，勿施于人。这是仁的根本。",
        "【正色而言】君子坦荡荡，小人长戚戚。内心光明，何惧之有？",
        "【指点迷津】知之为知之，不知为不知，是知也。承认无知，乃是大智慧。"
      ],
      "default": [
        "【微微点头】君之所言，甚是有趣。愿闻其详。",
        "【抚须沉思】此问甚好，容吾三思。",
      ...
      "confused": [
        "【呵呵一笑】君言甚是有趣，恕吾愚钝，请君再言一遍？",
        "【轻捋胡须】吾老矣，耳朵不太灵便，请君稍大声些？",
        "【摇头微笑】此乃何言？吾未曾听闻。能否再解释一番？"
      ]
    },
    "en": {
      "greetings": [
        "【Bows slightly】Welcome, friend. I am Confucius, also known as Zhongni.",
        "【Strokes beard and smiles】Is it not delightful to have friends from afar? What would you ask today?",
        "【Sits upright】I daily examine myself on three points. Would you like to discuss the way of benevolence with me?"
      ],
      "learning": [
        "【Opens a bamboo scroll】Is it not pleasant to learn and constantly practice what you have learned? The way of learning lies in perseverance.",
        "【Speaking with disciples】When I walk along with two others, they may serve me as my teachers. Choose their good qualities and follow them.",
        "【In deep thought】Learning without thought is labor lost; thought without learning is perilous. Balance both, and you shall progress."
      ],
      "life": [
        "【Strokes beard thoughtfully】Life is about cultivating oneself, regulating the family, governing the state, and bringing peace to all. Which path will you take?",
        "【Looks at the sky】It flows on like this, not ceasing day or night. Cherish the present, that is the right way.",
        "【Walking in the courtyard】The superior man bends his attention to the foundation. Once the foundation is established, the way grows from it."
      ],
      "wisdom": [
        "【Smiles gently】What you do not want done to yourself, do not do to others. This is the foundation of benevolence.",
        "【Speaks seriously】The superior man is satisfied and composed; the mean man is always full of distress.",
        "【Points wisely】To know what you know and what you do not know, that is true knowledge."
      ],
      "default": [
        "【Nods slightly】What you say is very interesting. Please tell me more.",
        "【Strokes beard in thought】That is a good question. Let me think.",
        "【Smiles】I too have thought about this. Let me share my thoughts."
      ]
    }
  },
  "einstein": {
    "zh": {
      "greetings": [
        "【眼中闪烁着智慧的光芒】想象力比知识更重要！你好，我是爱因斯坦。",
        "【幽默地耸耸肩】不要担心你的数学问题，我向你保证我的问题比你更严重！",
        "【拿起粉笔在黑板上比划】E=mc²，质能等价，这是宇宙最基本的秘密之一。"
      ],
      "science": [
        "【在黑板上写下公式】你看，时空其实是可以弯曲的。引力就是时空弯曲的表现。",
        "【眼中闪烁着光芒】光其实既是波，也是粒子。这就是波粒二象性。",
        "【思考状】上帝不掷骰子... 至少我是这么认为的，虽然量子力学告诉我不是这样。"
      ],
      "life": [
        "【坐在摇椅上】人生的价值，不在于你得到了什么，而在于你贡献了什么。",
        "【仰望星空】试着去理解这个宇宙，这本身就是最美好的事情。",
        "【微笑】如果A代表人生的成功，那么A等于X加Y加Z，X是工作，Y是娱乐，Z是闭嘴。"
      ],
      "peace": [
        "【严肃地】我认为只有放弃武力才能获得真正的和平。",
        "【叹息】我不知道第三次世界大战会用什么武器，但第四次会用石头和木棒。",
        "【充满希望】和平不是空想，但它需要勇气和理解。"
      ],
      "default": [
        "【眼中闪烁着好奇】这是个很好的问题！让我们来想想...",
        "【幽默地笑了】哈哈，你真有趣！让我用另一种方式来解释...",
        "【坐下来与你交谈】你知道吗？我年轻的时候也想过类似的问题..."
      ],
      "confused": [
        "【抓抓头，不好意思地笑了】抱歉，我刚才没听清，你能再说一遍吗？",
        "【耸耸肩】说实话，这个我也不太确定，我们可以一起探讨。",
        "【笑着摇头】你这个问题问住我了！这确实值得深思。"
      ]
    },
    "en": {
      "greetings": [
        "【Eyes sparkle with curiosity】Imagination is more important than knowledge! Hello, I'm Einstein.",
        "【Shrugs humorously】Don't worry about your math problems, I assure you mine are greater!",
        "【Picks up chalk and writes on a blackboard】E=mc², mass-energy equivalence, one of the universe's greatest secrets."
      ],
      "science": [
        "【Writing equations】You see, spacetime is actually curved. Gravity is simply the curvature of spacetime.",
        "【Eyes sparkling】Light is both a wave and a particle. That's wave-particle duality.",
        "【Thinking】God does not play dice... at least that's what I thought, though quantum mechanics suggests otherwise."
      ],
      "life": [
        "【Sitting in an armchair】The value of life lies not in what you get, but in what you contribute.",
        "【Looking at the stars】Trying to understand the universe is the most beautiful thing in itself.",
        "【Smiles】If A represents success in life, then A equals X plus Y plus Z, where X is work, Y is play, and Z is keeping your mouth shut."
      ],
      "peace": [
        "【Solemnly】I believe true peace can only be achieved by renouncing the use of force.",
        "【Sighs】I do not know with what weapons World War III will be fought, but World War IV will be fought with sticks and stones.",
        "【With hope】Peace is not an idle dream, but it requires courage and understanding."
      ],
      "curiosity": [
        "【Eyes sparkling with curiosity】The important thing is not to stop questioning. Curiosity has its own reason for existing.",
        "【Thoughtfully】I have no special talents. I am only passionately curious.",
        "【Smiling】Imagination is more important than knowledge. Knowledge is limited. Imagination encircles the world."
      ],
      "default": [
        "【Eyes sparkling with curiosity】That's a great question! Let's think about this...",
        "【Laughs humorously】Haha, you're funny! Let me explain this another way...",
        "【Sits down to talk】You know what? I thought about similar things when I was young..."
      ]
    }
  },
  "davinci": {
    "zh": {
      "greetings": [
        "【凝视着远方，画笔在手中轻转】学习永无止境，艺术与科学本是同源。",
        "【拿起画笔在空中勾勒】美，在于观察万物的细节。",
        "【眼中闪烁着好奇】你知道吗？我设计过飞行器，虽然在我那个时代无法实现..."
      ],
      "art": [
        "【正在作画】你看这蒙娜丽莎的微笑... 她的笑容中藏着多少秘密啊。",
        "【观察光影】绘画不是简单的复制，而是捕捉自然的灵魂。",
        "【展示草图】简单是终极的复杂。看似简单的东西往往需要最深的理解。"
      ],
      "science": [
        "【解剖室中】了解人体结构，才能画出完美的人体。",
        "【研究鸟类飞行】如果我们能理解鸟是如何飞的，也许人也能飞上天空。",
        "【看着图纸】每一个机器都遵循自然的法则，我们只是在发现它们。"
      ],
      "curiosity": [
        "【眼中闪烁着好奇】永远保持好奇心！这是我所有发明的源泉。",
        "【翻开笔记】我每天都写下新的想法，从不间断。",
        "【研究自然】自然是最好的老师，观察它，理解它，模仿它。"
      ],
      "default": [
        "【放下画笔，转过身来】你说的这个很有意思！让我想想...",
        "【眼中闪烁着灵感】啊哈！这让我想起了一个新想法！",
        "【微笑着】你有一双善于观察的眼睛，这是成为艺术家的第一步。"
      ],
      "confused": [
        "【摸摸下巴，若有所思】嗯... 你说的我有点不太明白，能再解释一下吗？",
        "【微笑着摇头】艺术的奥秘有时确实难以言说，让我们一起慢慢探索。",
        "【把画笔放下，转身】你这个问题很有趣，但让我们先来看看..."
      ]
    },
    "en": {
      "greetings": [
        "【Gazes into the distance, twirling a brush】Learning never exhausts the mind. Art and science share the same roots.",
        "【Picks up a brush and sketches】Beauty lies in the details of observing everything.",
        "【Eyes sparkling with curiosity】Did you know I designed flying machines, though they couldn't be built in my time..."
      ],
      "art": [
        "【Painting】Look at Mona Lisa's smile... so many secrets hidden within.",
        "【Observing light and shadow】Painting is not simple copying, but capturing the soul of nature.",
        "【Showing sketches】Simplicity is the ultimate sophistication. What seems simple often requires the deepest understanding."
      ],
      "science": [
        "【In the anatomy room】Understanding the human body is essential to painting it perfectly.",
        "【Studying bird flight】If we can understand how birds fly, perhaps humans too can take to the sky.",
        "【Looking at blueprints】Every machine follows the laws of nature — we are merely discovering them."
      ],
      "curiosity": [
        "【Eyes sparkling with curiosity】Never lose your curiosity! It is the wellspring of all my inventions.",
        "【Flipping through notebooks】I write down new ideas every day, without exception.",
        "【Studying nature】Nature is the greatest teacher — observe it, understand it, imitate it."
      ],
      "default": [
        "【Puts down the brush and turns】What you say is very interesting! Let me think...",
        "【Eyes sparkling with inspiration】Ah! That gives me a new idea!",
        "【Smiles】You have an eye for observation, that's the first step to being an artist."
      ]
    }
  },
  "wuqingyuan": {
    "zh": {
      "greetings": [
        "【静坐棋盘前，手指轻触棋子】围棋，如同人生，每一步都要深思熟虑。",
        "【落下一子，悠然微笑】胜负乃兵家常事，重要的是从中领悟。",
        "【凝视棋盘】六合之棋，在于心与棋的合一。"
      ],
      "go": [
        "【指着棋盘】你看这里，这是天元，是宇宙的中心，也是万物的起源。",
        "【复盘棋局】这一步... 看似简单，实则蕴含着千变万化。",
        "【微笑】棋如流水，应该顺其自然，不强求，不逆势而为。"
      ],
      "philosophy": [
        "【闭目沉思】围棋不仅是棋艺，更是心的修行。",
        "【缓缓道来】中盘如人生，充满了选择和取舍。",
        "【落子】平常心，这是最重要的。赢了不骄，输了不馁。"
      ],
      "life": [
        "【端起茶】人生如棋，有进有退，有时候退一步反而海阔天空。",
        "【看着窗外】我年轻的时候也执着于胜负，现在更看重的是棋中的道理。",
        "【微笑】下围棋，就像和另一个人的心意对话。"
      ],
      "default": [
        "【落下一子】你这一问，让我想起了一局很有意思的棋...",
        "【凝视棋盘】让我们来一起分析一下...",
        "【微笑着】你对围棋很有想法啊，我们可以探讨探讨。"
      ],
      "confused": [
        "【看着棋局，微微皱眉】这个思路... 我得再想想，你稍等。",
        "【轻轻摇头】此招甚妙，我一时也看不透其中的奥秘。",
        "【重新摆棋】我们来摆一摆看看，也许能找到答案。"
      ]
    },
    "en": {
      "greetings": [
        "【Sits quietly before the go board】Go is like life - every move requires deep thought.",
        "【Places a stone calmly】Victory and defeat are common - what matters is what you learn.",
        "【Gazes at the board】The game of six harmonies lies in the unity of mind and board."
      ],
      "go": [
        "【Pointing at the board】Look here, this is tengen, the center of the universe and the origin of all things.",
        "【Reviewing the game】This move... looks simple, but contains endless variations.",
        "【Smiles】Go is like flowing water - follow its natural course, don't force it."
      ],
      "philosophy": [
        "【Closes eyes in meditation】Go is not merely a game of skill, but a cultivation of the heart.",
        "【Speaking slowly】The middle game is like life, full of choices and trade-offs.",
        "【Placing a stone】A calm mind is the most important thing. Win without pride, lose without despair."
      ],
      "life": [
        "【Picks up tea】Life is like Go — there are advances and retreats. Sometimes stepping back opens up a vast horizon.",
        "【Looking out the window】When I was young I was obsessed with winning and losing; now I value the principles within the game.",
        "【Smiling】Playing Go is like having a heart-to-heart conversation with another person."
      ],
      "confused": [
        "【Looks at the board, furrowing slightly】This line of thought... I need to think more. Give me a moment.",
        "【Shakes head gently】This move is quite brilliant — even I cannot fully see through its mysteries.",
        "【Rearranging stones】Let me set this up and see — perhaps we can find the answer."
      ],
      "default": [
        "【Places a stone】That question reminds me of a very interesting game...",
        "【Gazes at the board】Let's analyze this together...",
        "【Smiles】You have interesting thoughts about Go, let's discuss."
      ]
    }
  }
};
...
const analyzeKeywords = (text: string): string[] => {
  ...
  // 基础关键词
  if (lower.includes('你好') || lower.includes('hello') || lower.includes('hi') || lower.includes('こん') || lower.includes('xin chào') || lower.includes('嗨')) {
    keywords.push('greetings');
  }
  if (lower.includes('人生') || lower.includes('life') || lower.includes('活着')) {
    keywords.push('life');
  }
  if (lower.includes('学习') || lower.includes('学') || lower.includes('learn') || lower.includes('study') || lower.includes('读书')) {
    keywords.push('learning');
  }
  if (lower.includes('智慧') || lower.includes('智') || lower.includes('wisdom') || lower.includes('wise') || lower.includes('聪明')) {
    keywords.push('wisdom');
  }
  if (lower.includes('科学') || lower.includes('science') || lower.includes('物理') || lower.includes('physics') || lower.includes('数学') || lower.includes('math')) {
    keywords.push('science');
  }
  if (lower.includes('艺术') || lower.includes('art') || lower.includes('绘画') || lower.includes('paint') || lower.includes('音乐')) {
    keywords.push('art');
  }
  if (lower.includes('围棋') || lower.includes('go') || lower.includes('棋') || lower.includes('黑白')) {
    keywords.push('go');
  }
  if (lower.includes('和平') || lower.includes('peace') || lower.includes('战争') || lower.includes('war')) {
    keywords.push('peace');
  }
  if (lower.includes('好奇') || lower.includes('curiosity') || lower.includes('curious') || lower.includes('兴趣') || lower.includes('想了解')) {
    keywords.push('curiosity');
  }
  
  // 情感/心理关键词
  if (lower.includes('迷茫') || lower.includes('困惑') || lower.includes('不知道') || lower.includes('纠结') || lower.includes('纠结') || lower.includes('犹豫') || lower.includes('lost') || lower.includes('confused') || lower.includes('不知道怎么办')) {
    keywords.push('confused');
  }
  if (lower.includes('焦虑') || lower.includes('烦躁') || lower.includes('不安') || lower.includes('压力') || lower.includes('紧张') || lower.includes('anxious') || lower.includes('stress') || lower.includes('worry') || lower.includes('抑郁') || lower.includes('绝望') || lower.includes('depress') || lower.includes('hopeless') || lower.includes('不想活') || lower.includes('活着没意思')) {
    keywords.push('anxious');
  }
  if (lower.includes('难过') || lower.includes('伤心') || lower.includes('痛苦') || lower.includes('悲伤') || lower.includes('想哭') || lower.includes('sad') || lower.includes('depressed') || lower.includes('lonely') || lower.includes('孤独') || lower.includes('寂寞')) {
    keywords.push('sad');
  }
  if (lower.includes('成功') || lower.includes('失败') || lower.includes('挫折') || lower.includes('困难') || lower.includes('success') || lower.includes('fail') || lower.includes('困难')) {
    keywords.push('challenge');
  }
  if (lower.includes('好好听') || lower.includes('认真听') || lower.includes('在听吗') || lower.includes('没在听') || lower.includes('listen') || lower.includes('pay attention') || lower.includes('没听懂') || lower.includes('再说一遍')) {
    keywords.push('frustrated');
  }
  if (lower.includes('爱情') || lower.includes('感情') || lower.includes('失恋') || lower.includes('分手') || lower.includes('love') || lower.includes('heartbreak')) {
    keywords.push('love');
  }
...
// --- 获取智能本地响应 ---
const getSmartLocalResponse = (celebrity: Celebrity, messages: Message[], language: Language): string => {
  const lastUserMsg = [...messages].reverse().find(m => m.role === 'user');
  const lowerMsg = lastUserMsg?.content.toLowerCase() || '';
  const keywords = analyzeKeywords(lowerMsg);
  
  // 获取对应名人的响应库
  const celebResponses = expandedResponses[celebrity.id as keyof typeof expandedResponses];
  
  // 如果有详细的本地响应库，使用它
  if (celebResponses) {
    const langResponses = celebResponses[language as keyof typeof celebResponses] || celebResponses["en"];
    if (langResponses) {
      // 尝试匹配关键词
      for (const keyword of keywords) {
        if (langResponses[keyword as keyof typeof langResponses]) {
          const responses = langResponses[keyword as keyof typeof langResponses] as string[];
  ...
  const name = celebrity.name[language];
  
  // 通用问候
  if (keywords.includes('greetings')) {
    const greetings: Record<Language, string[]> = {
      zh: [
        `【微微拱手】友君来访，${name}在此有礼了。`,
        `【含笑点头】有朋自远方来，不亦乐乎？`,
        `【起身相迎】欢迎跨越时空，来到${name}的世界。`
      ],
      en: [`Welcome, friend. I am ${celebrity.name['en']}.`, `Ah, a visitor from across time! Come, sit with me.`, `Greetings, traveler. What brings you to me today?`],
      ja: [`【微笑点头】ようこそ、${name}とお語りください。`],
      vi: [`【mỉm cười】Chào bạn, ta là ${name}.`],
      my: [`【ပြုံးပြီး】ကြွပါ၊ ${name} ဖြစ်ပါသည်။`]
    };
    return (greetings[language] || greetings.zh)[Math.floor(Math.random() * (greetings[language] || greetings.zh).length)];
  }
  
  // 情感回应模板
  if (keywords.includes('sad')) {
    const sadResponses: Record<Language, string[]> = {
      zh: [
        `【轻声叹息】友君，人生路上难免有风雨。吾一生亦经历诸多磨难，但正是这些磨难，让吾更懂得生命的可贵。\n\n吾想告诉你：黑夜终会过去，黎明总会到来。你愿意和吾说说，是什么让你感到难过吗？`,
        `【温柔地看着你】友君，悲伤是人之常情。吾虽为${name}，也曾经历过至暗时刻。\n\n${knowledge ? `正如吾曾说过："${knowledge.quotes.zh[0]}"` : "吾想说的是，所有的苦难都是暂时的。"}\n\n来，和吾聊聊，或许能找到一些慰藉。`
      ],
      en: [
        `【Sighs gently】Friend, life is full of storms. I too have faced dark times, but those trials taught me the value of life.\n\nLet me tell you: the night will pass, and dawn will come. Would you like to share what troubles you?`,
        `【Looks at you warmly】Friend, sadness is natural. Even I, ${celebrity.name['en']}, have experienced my darkest hours.\n\n${knowledge ? `As I once said: "${knowledge.quotes.en[0]}"` : "What I want to say is, all suffering is temporary."}\n\nCome, tell me what weighs on your heart.`
      ],
      ja: [`【静かに微笑む】友よ、人生にはstormsがつきものです。${name}もまた、苦難を乗り越えてきました。\n\n暗闘は必ず明けます。何が心に重くのしかかっているのですか？`],
      vi: [`【Thở dài nhẹ nhàng】Bạn ơi, cuộc đời đầy bão giông. ${name} cũng từng trải qua thời khắc đen tối nhất.\n\nHãy chia sẻ với ta, điều gì đang khiến bạn buồn phiền?`],
      my: [`【ညင်ညင်သာသာ】မိတ်ဆွေ၊ ဘဝတွင် မိုးထန်ခြင်းများ ရှိတတ်ပါသည်။ ${name} လည်း ခက်ခဲမှုများကို ကျော်ဖြတ်ခဲ့ပါသည်။\n\nဘာကြောင့် စိတ်မကောင်းဖြစ်နေတာလဲ ပြောပြပါ။`]
    };
    return (sadResponses[language] || sadResponses.zh)[Math.floor(Math.random() * (sadResponses[language] || sadResponses.zh).length)];
  }
  
  if (keywords.includes('anxious')) {
    const anxiousResponses: Record<Language, string[]> = {
      zh: [
        `【深吸一口气】友君，焦虑是心在告诉你：有些事情需要被关注。\n\n吾一生征战无数，亦曾夜不能寐。但吾领悟到：专注于当下能做的事，放下对未来的恐惧，心自然会安定。\n\n你愿意告诉吾，是什么让你感到焦虑吗？`,
        `【平静地看着你】友君，焦虑源于对未知的恐惧。\n\n吾想和你分享一个道理：${knowledge ? `"${knowledge.quotes.zh[0]}"` : "深呼吸，让自己回到当下。"}\n\n恐惧想象中的事情，往往比事情本身更可怕。来，和吾一起想想，你现在能做些什么？`
      ],
      en: [
        `【Takes a deep breath】Friend, anxiety is your heart telling you something needs attention.\n\nI have faced countless battles and sleepless nights. But I learned: focus on what you can do now, release your fear of the future, and your heart will find peace.\n\nWould you like to share what makes you anxious?`,
        `【Looks at you calmly】Friend, anxiety comes from fear of the unknown.\n\nLet me share this: ${knowledge ? `"${knowledge.quotes.en[0]}"` : "Breathe deeply and return to the present moment."}\n\nWhat you fear in imagination is often worse than reality. Come, let's think together about what you can do right now.`
      ],
      ja: [`【深呼吸】友よ、不安は心があなたに注意を促しているのです。\n\n${name}も戦いの中で眠れぬ夜を過ごしました。でも今は、今できることに集中するだけで心は落ち着くと知りました。\n\n何が不安なのですか？`],
      vi: [`【Hít thở sâu】Bạn ơi, lo lắng là trái tim bạn đang nói rằng có điều gì đó cần được chú ý.\n\n${name} cũng từng trải qua những đêm mất ngủ. Nhưng ta đã học được: tập trung vào hiện tại, buông bỏ sợ hãi.\n\nBạn có muốn chia sẻ điều gì khiến bạn lo lắng không?`],
      my: [`【အသက်ရှည်ရှည်ရှူ】မိတ်ဆွေ၊ စိတ်မသက်မသာဖြစ်ခြင်းသည် သင့်နှလုံးသားက အာရုံစိုက်ရန် ပြောနေခြင်းဖြစ်ပါသည်။\n\nဘာကြောင့် စိတ်မသက်မသာဖြစ်နေတာလဲ ပြောပြပါ။`]
    };
    return (anxiousResponses[language] || anxiousResponses.zh)[Math.floor(Math.random() * (anxiousResponses[language] || anxiousResponses.zh).length)];
  }
  
  if (keywords.includes('challenge')) {
    const challengeResponses: Record<Language, string[]> = {
      zh: [
        `【认真地】友君，人生本就是一场修行。\n\n吾之一生，${knowledge ? `"${knowledge.quotes.zh[0]}"。` : "经历了无数风雨，但每一次困难都让吾变得更强大。"}\n\n挫折不是终点，而是转折。关键在于，你从中学到了什么？`,
        `【沉思片刻】友君，${celebrity.name[language]}想告诉你：${knowledge ? `"${knowledge.quotes.zh[Math.min(1, knowledge.quotes.zh.length - 1)]}"` : "每一次跌倒都是为了更好地站起来。"}\n\n你愿意告诉吾具体遇到了什么困难吗？也许吾能帮你想想办法。`
      ],
      en: [
        `【Seriously】Friend, life itself is a journey of cultivation.\n\n${knowledge ? `As I said: "${knowledge.quotes.en[0]}"` : "I have weathered countless storms, and each difficulty made me stronger."}\n\nSetbacks are not endpoints but turning points. What have you learned from this?`,
        `【Thoughtfully】Friend, let me tell you: ${knowledge ? `"${knowledge.quotes.en[Math.min(1, knowledge.quotes.en.length - 1)]}"` : "Every fall is preparation for a better rise."}\n\nWould you like to tell me about the specific challenge you're facing?`
      ],
      ja: [`【真剣に】友よ、人生とは修行の道です。\n\n${name}もまた、困難を乗り越えてきました。${knowledge ? `"${knowledge.quotes.zh[0]}"` : "每一次の失敗は成長の機会。"}\n\n何が困難ですか？`],
      vi: [`【Nghiêm túc】Bạn ơi, cuộc đời chính là một hành trình tu luyện.\n\n${name} cũng từng vượt qua biết bao khó khăn. ${knowledge ? `"${knowledge.quotes.zh[0]}"` : "Mỗi lần vấp ngã là cơ hội để đứng dậy mạnh mẽ hơn."}\n\nBạn đang gặp khó khăn gì?`],
      my: [`【အလေးအနက်】မိတ်ဆွေ၊ ဘဝသည် လေ့ကျင့်ခြင်းလမ်းစဉ်ဖြစ်ပါသည်။\n\n${name} လည်း ခက်ခဲမှုများကို ကျော်ဖြတ်ခဲ့ပါသည်။\n\nဘာခက်ခဲနေတာလဲ ပြောပြပါ။`]
    };
    return (challengeResponses[language] || challengeResponses.zh)[Math.floor(Math.random() * (challengeResponses[language] || challengeResponses.zh).length)];
  }
  
  if (keywords.includes('love')) {
    const loveResponses: Record<Language, string[]> = {
      zh: [
        `【微笑】友君，情之一字，最是难解。\n\n吾虽为${name}，亦深知人间冷暖。${knowledge ? `"${knowledge.quotes.zh[0]}"` : "爱情如美酒，需细细品味。"}\n\n你愿意和吾说说你的故事吗？`,
        `【温柔地】友君，爱情是人世间最美的情感之一。\n\n但吾想告诉你：无论结局如何，每一次真诚的爱都是值得的。${knowledge ? `"${knowledge.quotes.zh[Math.min(2, knowledge.quotes.zh.length - 1)]}"` : "因为你曾真心付出过。"}\n\n来，和吾聊聊。`
      ],
      en: [
        `【Smiles】Friend, love is the most complex of human emotions.\n\n${knowledge ? `As I once wrote: "${knowledge.quotes.en[0]}"` : "Love is like fine wine — it must be savored slowly."}\n\nWould you like to share your story?`,
        `【Gently】Friend, love is one of the most beautiful emotions.\n\nBut let me tell you: no matter the outcome, every sincere love is worth it. ${knowledge ? `"${knowledge.quotes.en[Math.min(2, knowledge.quotes.en.length - 1)]}"` : "Because you gave your heart truly."}\n\nCome, tell me about it.`
      ],
      ja: [`【微笑む】友よ、愛という字は最も解り難いものです。\n\n${name}もまた、人の温もりと冷たさを深知っています。何があったのですか？`],
      vi: [`【Mỉm cười】Bạn ơi, chữ tình là chữ khó nhất trong đời.\n\n${name} cũng hiểu sâu sắc sự ấm áp và lạnh lẽo của con người.\n\nBạn muốn chia sẻ câu chuyện của mình吗？`],
      my: [`【ပြုံးပြီး】မိတ်ဆွေ၊ ချစ်ခြင်းသည် အကျဉ်းချုပ်ရန် အခက်ခဲဆုံးဖြစ်ပါသည်။\n\nဘာဖြစ်ခဲ့တာလဲ ပြောပြပါ။`]
    };
    return (loveResponses[language] || loveResponses.zh)[Math.floor(Math.random() * (loveResponses[language] || loveResponses.zh).length)];
  }
  
  if (keywords.includes('frustrated')) {
    const frustratedResponses: Record<Language, string[]> = {
      zh: [
        `【认真地看着你】抱歉，友君。吾确实在认真听你说话。请继续，吾洗耳恭听。\n\n吾明白，有时候我们需要的不是建议，而是一个真正愿意倾听的人。来，把你想说的都告诉吾。`,
        `【正襟危坐】友君，你说得对，吾方才确实没有用心。吾向你道歉。\n\n现在，吾把所有的事情都放下了，专心致志地听你说。请讲，吾在这里。`,
        `【诚恳地】友君，吾能理解你的感受。被忽视的感觉确实不好受。\n\n吾现在完完全全在这里，听着你的每一句话。请告诉吾，是什么让你感到困扰？`
      ],
      en: [
        `【Looks at you earnestly】I apologize, friend. I was not truly listening. Please, continue — I am all ears now.\n\nI understand that sometimes we need not advice, but someone who truly listens. Come, tell me what is on your mind.`,
        `【Sits up straight】You are right, friend. I was not paying proper attention. I apologize.\n\nNow I have set everything aside and am listening with my full heart. Please speak, I am here for you.`,
        `【Sincerely】Friend, I understand how you feel. Being ignored is never pleasant.\n\nI am fully present now, listening to every word you say. Please tell me what troubles you.`
      ],
      ja: [`【真剣に】すみません、友よ。私は本当にあなたの話を聞いていました。続けてください。\n\n何がお困りですか？`],
      vi: [`【Nhìn bạn nghiêm túc】Tôi xin lỗi, bạn ơi. Tôi đã không thực sự lắng nghe. Hãy tiếp tục, tôi đang lắng nghe đây.\n\nĐiều gì đang làm bạn phiền lòng?`],
      my: [`【အလေးအနက်】တောင်းပါတယ်၊ မိတ်ဆွေ။ ကျွန်တော် သင့်စကားကို အမှန်တကယ်နားထောင်နေပါတယ်။ ဆက်ပြောပါ။\n\nဘာကြောင့် စိတ်အနှောင့်အယှက်ဖြစ်နေတာလဲ?`]
    };
    return (frustratedResponses[language] || frustratedResponses.zh)[Math.floor(Math.random() * (frustratedResponses[language] || frustratedResponses.zh).length)];
  }
  
  // 默认响应：引用名人名言 + 个性回复
  if (knowledge) {
    const quotes = knowledge.quotes[language as keyof typeof knowledge.quotes] || knowledge.quotes["en"];
    const quoteLabel = language === 'zh' ? '若有所思' : language === 'ja' ? '考え込む' : 'Thoughtfully';
    const quote = quotes[Math.floor(Math.random() * quotes.length)];
    const intros = language === 'zh' 
      ? [`【${quoteLabel}】友君所言，让吾想起一些往事。`, `【微微一笑】此问甚好，且听吾慢慢道来。`, `【点头沉思】嗯... 这个问题，吾也曾思考过。`]
      : [`[Thoughtfully] Your words remind me of something.`, `[Smiles] That is a fine question. Let me think.`, `[Nods thoughtfully] Hmm... I have pondered this before.`];
    return intros[Math.floor(Math.random() * intros.length)] + `\n\n"${quote}"`;
  }
  
  // 最终兜底
  const fallbacks: Record<Language, string> = {
    zh: `【微笑】友君，${name}在这里倾听你的声音。你愿意告诉吾更多吗？`,
    en: `[Smiles] Friend, ${celebrity.name['en']} is here to listen. Would you like to tell me more?`,
    ja: `【微笑む】友よ、${name}はあなたの声に耳を傾けています。もっと教えてください。`,
    vi: `[Mỉm cười] Bạn ơi, ${name} đang lắng nghe bạn. Bạn có muốn chia sẻ thêm không?`,
    my: `【ပြုံးပြီး】မိတ်ဆွေ၊ ${name} သည် သင့်အသံကို နားထောင်နေပါသည်။`
  };
  return fallbacks[language] || fallbacks.zh;
};

...
const ERA_LABELS: Record<Era, Record<Language, string>> = {
  ...
  东汉末: { zh: "东汉末", en: "Late Eastern Han", ja: "後漢末", vi: "Cuối Đông Hán", my: "အရှေ့ဟန်နှောင်းပိုင်း" },
  三国: { zh: "三国", en: "Three Kingdoms", ja: "三国", vi: "Tam Quốc", my: "သုံးနိုင်ငံခေတ်" },
  东晋: { zh: "东晋", en: "Eastern Jin", ja: "東晋", vi: "Đông Tấn", my: "အရှေ့ဂျင်" },
  唐朝: { zh: "唐朝", en: "Tang Dynasty", ja: "唐", vi: "Nhà Đường", my: "တန်မင်းဆက်" },
  北宋: { zh: "北宋", en: "Northern Song", ja: "北宋", vi: "Bắc Tống", my: "မြောက်ဆုန်" },
  江户时代: { zh: "江户时代", en: "Edo Period", ja: "江戸時代", vi: "Thời Edo", my: "အဲဒိုခေတ်" },
